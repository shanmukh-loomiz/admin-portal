    ...
    <div className="ml-[340px] mt-[75px] p-6 min-h-[calc(100vh-75px)] mr-[50px] bg-[#F2F4F7] rounded-[20px] mb-[50px]">
      ...
      <div className="mb-6 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <Card title="Unverified profile" count="8" route="/orders/websiteData/unverifiedProfiles"  />
          <Card title="Verified brands" count="16" route="/orders/websiteData/verifiedProfiles"  />
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <Card title="Quote received" count="8"  route="/orders/websiteData/RFQReceived" />
          <Card title="Orders approved" count="16" route="/"  />
          <Card title="Rejected" count="9"  route="/" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <Card title="Samples Sent" count="8" route="/" />
          <Card title="Ready for shipment" count="16" route="/"  />
        </div>
      </div>
    </div>
  );
...
const Card = ({ title, count, route }) => (
    <div className="bg-white rounded-lg p-5 shadow-sm flex justify-between items-start">
      ...
      {route ? (
        ...
        <button className="text-[#194185] text-sm font-medium  opacity-50">
          View all
        </button>
      )}
    </div>
